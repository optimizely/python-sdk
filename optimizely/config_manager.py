...
class BaseConfigManager(ABC):
    ...
    def __init__(
        self, logger: Any = None, error_handler: Any = None, notification_center: Optional[NotificationCenter] = None
    ):
...
class StaticConfigManager(BaseConfigManager):
    ...
    def __init__(
        ...
        self._config: project_config.ProjectConfig = None  # type: ignore
