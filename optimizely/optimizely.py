...
class Optimizely(object):
    ...
    def __init__(self,
        ...
        Args:
          ...
          skip_json_validation: Optional boolean param which allows skipping JSON schema validation upon
                                object invocation. By default JSON schema validation will be performed.
    ...
    def _get_feature_variable_for_type(self, feature_key, variable_key, variable_type, user_id, attributes):
        """ Helper method to determine value for a certain variable
            attached to a feature flag based on type of variable.
