        ...
        for listener_add in with_listener:
            if listener_add['type'] == 'Activate':
                ...
                for i in range(count):
                    ...
                    optimizely_instance.notification_center.add_notification_listener(enums.NotificationTypes.ACTIVATE,
                                                                                      a_cb)
            if listener_add['type'] == 'Track':
                ...
                for i in range(count):
                    ...
                    optimizely_instance.notification_center.add_notification_listener(enums.NotificationTypes.TRACK,
                                                                                      t_cb)
...
def get_feature_variable_string():
    ...
    user_profiles = user_profile_service_instance.user_profiles.values() if user_profile_service_instance else {}
    return json.dumps({'result': string_value, 'user_profiles': user_profiles}), 200, {
