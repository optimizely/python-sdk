...
class CustomAttributeConditionEvaluatorLogging(base.BaseTest):
    ...
    def test_evaluate__match_type__invalid(self):
        ...
        mock_log.assert_called_once_with((
            ...
            'type. You may need to upgrade to a newer release of the Optimizely SDK.').format(
    ...
    def test_evaluate__condition_type__invalid(self):
        ...
        mock_log.assert_called_once_with((
            ...
            'You may need to upgrade to a newer release of the Optimizely SDK.').format(
            json.dumps(expected_condition_log)
        ))
    ...
    def test_exact__user_value__missing(self):
        ...
        mock_log.assert_called_once_with((
            ...
            'no value was passed for user attribute "favorite_constellation".').format(
            json.dumps(expected_condition_log)))
    ...
    def test_greater_than__user_value__missing(self):
        ...
        mock_log.assert_called_once_with((
            ...
            'attribute "meters_travelled".').format(
            json.dumps(expected_condition_log)
        ))
    ...
    def test_greater_than__user_value__None(self):
        ...
        mock_log.assert_called_once_with((
            ...
            'user attribute "meters_travelled".').format(
            json.dumps(expected_condition_log)))
    ...
    def test_less_than__user_value__None(self):
        ...
        mock_log.assert_called_once_with((
            ...
            'for user attribute "meters_travelled".').format(
            json.dumps(expected_condition_log)))
    ...
    def test_substring__user_value__None(self):
        ...
        mock_log.assert_called_once_with((
            ...
            'passed for user attribute "headline_text".').format(
            json.dumps(expected_condition_log)))
    ...
    def test_exact__user_value__unexpected_type(self):
        ...
        mock_log.assert_called_once_with((
            ...
            'user attribute "favorite_constellation".').format(
            json.dumps(expected_condition_log), type({})))
    ...
    def test_substring__user_value__unexpected_type(self):
        ...
        mock_log.assert_called_once_with((
            'Audience condition "{}" evaluated to UNKNOWN because a value of type "{}" was passed for '
            'user attribute "headline_text".').format(
            json.dumps(expected_condition_log), type(1234)))
    ...
    def test_exact__user_value__infinite(self):
        ...
        mock_log.assert_called_once_with((
            ...
            'user attribute "meters_travelled" is not in the range [-2^53, +2^53].').format(
            json.dumps(expected_condition_log)))
    ...
    def test_exact__user_value_type_mismatch(self):
        ...
        mock_log.assert_called_once_with((
            'Audience condition "{}" evaluated to UNKNOWN because a value of type "{}" was passed for '
            'user attribute "favorite_constellation".').format(
            json.dumps(expected_condition_log), type(5)))
    ...
    def test_exact__condition_value_invalid(self):
        ...
        mock_log.assert_called_once_with((
            ...
            'newer release of the Optimizely SDK.').format(
            json.dumps(expected_condition_log)))
