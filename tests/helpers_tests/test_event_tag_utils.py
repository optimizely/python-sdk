...
class EventTagUtilsTest(unittest.TestCase):
    ...
    def test_get_numeric_metric__value_tag(self):
        ...
        numeric_value_invalid_literal = event_tag_utils.get_numeric_value({'value': '1,234'},
        ...
        numeric_value_neg_inf = event_tag_utils.get_numeric_value({'value': float('-inf')},
                                                                  logger=logger.SimpleLogger())
