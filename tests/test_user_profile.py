...
class UserProfileTest(unittest.TestCase):
    ...
    def test_set_variation_for_experiment__no_previous_decision(self):
        ...
        self.assertEqual({'199912': {'variation_id': '14512525'},
                          '1993412': {'variation_id': '118822'}}, self.profile.experiment_bucket_map)
...
class UserProfileServiceTest(unittest.TestCase):
    def test_lookup(self):
        ...
        self.assertEqual({'user_id': 'test_user', 'experiment_bucket_map': {}},
                         user_profile_service.lookup('test_user'))
