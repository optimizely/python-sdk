...
class ConfigTest(base.BaseTest):
    ...
    def test_get_variable_value_for_variation__no_usage_of_variable(self):
        ...
        self.assertEqual('45',
                         project_config.get_variable_value_for_variation(variable_without_usage_variable, variation))
    ...
    def test_set_forced_variation__multiple_sets(self):
        ...
        self.assertEqual(self.project_config.get_forced_variation('group_exp_1', 'test_user_1').key,
                         'group_exp_1_control')
        ...
        self.assertEqual(self.project_config.get_forced_variation('group_exp_1', 'test_user_2').key,
                         'group_exp_1_control')
