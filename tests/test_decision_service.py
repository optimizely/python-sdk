...
class DecisionServiceTest(base.BaseTest):
    ...
    def test_get_variation__experiment_not_running(self):
        ...
        with mock.patch(
            'optimizely.decision_service.DecisionService.get_forced_variation') as mock_get_forced_variation, \
                mock.patch.object(self.decision_service, 'logger') as mock_decision_logging, \
                mock.patch('optimizely.decision_service.DecisionService.'
                           'get_stored_variation') as mock_get_stored_variation, \
    ...
    def test_get_variation__user_bucketed_for_new_experiment__user_profile_service_available(self):
        ...
        experiment = self.project_config.get_experiment_from_key('test_experiment')
        with mock.patch.object(self.decision_service, 'logger') as mock_decision_logging, \
                mock.patch('optimizely.decision_service.DecisionService.get_forced_variation',
                           return_value=None) as mock_get_forced_variation, \
                mock.patch('optimizely.decision_service.DecisionService.get_stored_variation',
                           return_value=None) as mock_get_stored_variation, \
                mock.patch('optimizely.helpers.audience.is_user_in_experiment',
                           return_value=True) as mock_audience_check, \
...
class FeatureFlagDecisionTests(base.BaseTest):
    ...
    def test_get_variation_for_rollout__returns_decision_if_user_in_rollout(self):
        ...
        mock_bucket.assert_called_once_with(self.project_config.get_experiment_from_id('211127'), 'test_user',
                                            'test_user')
    ...
    def test_get_variation_for_rollout__skips_to_everyone_else_rule(self):
        ...
        self.assertEqual(
            [mock.call(
                self.project_config,
                self.project_config.get_experiment_from_key('211127'), None, mock_decision_logging
            ), mock.call(
    ...
    def test_get_variation_for_rollout__returns_none_for_user_not_in_rollout(self):
        ...
        self.assertEqual([mock.call(
            ...
            mock.call(
                self.project_config,
                self.project_config.get_experiment_from_key('211137'), None, mock_decision_logging),
            mock.call(
                self.project_config,
                self.project_config.get_experiment_from_key('211147'), None, mock_decision_logging)],
            mock_audience_check.call_args_list
        )
    ...
    def test_get_variation_for_feature__returns_variation_for_feature_in_rollout(self):
        ...
        self.assertEqual(0, len(mock_decision_logging.method_calls))
    ...
    def test_get_variation_for_feature__returns_variation_for_feature_in_group(self):
        ...
        mock_decision.assert_called_once_with(self.project_config.get_experiment_from_key('group_exp_1'), 'test_user',
                                              None)
