...
class DecisionServiceTest(base.BaseTest):
    ...
    def test_get_bucketing_id__no_bucketing_id_attribute(self):
        ...
        # No attributes
        self.assertEqual(
            "test_user", self.decision_service._get_bucketing_id("test_user", None)
        )

        # With attributes, but no bucketing ID
        self.assertEqual(
            "test_user",
            self.decision_service._get_bucketing_id(
    ...
    def test_get_whitelisted_variation__user_in_forced_variation(self):
        ...
        with mock.patch.object(
            ...
            self.assertEqual(
                ...
                self.decision_service.get_whitelisted_variation(
    ...
    def test_get_stored_variation__stored_decision_available(self):
        ...
        with mock.patch.object(
            ...
            self.assertEqual(
                entities.Variation("111128", "control"),
                self.decision_service.get_stored_variation(
...
class FeatureFlagDecisionTests(base.BaseTest):
    ...
    the experiment in the rollout that the user is bucketed into. """
        ...
        with \
            get_variation_for_rollout_patch as mock_get_variation_for_rollout, \
    ...
    def test_get_experiment_in_group(self):
        ...
        with mock.patch(
            ...
            self.assertEqual(
                experiment,
                self.decision_service.get_experiment_in_group(
