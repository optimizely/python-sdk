...
* Added a new API to get a project configuration static data.
  ...
  * For details, refer to a documentation page: [https://docs.developers.optimizely.com/full-stack/docs/optimizelyconfig-python](https://docs.developers.optimizely.com/full-stack/docs/optimizelyconfig-python).
